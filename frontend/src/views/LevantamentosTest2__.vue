                    ...
                    for (const cor in this.subgrouped_items_bycolor_obj[ref_group]) {
                        ...
                        for (const prod in this.subgrouped_items_bycolor_obj[ref_group][cor]) {
                            ...
                            if (
                                ...
                                console.log(movtos[prod])
                                console.log("isNaN(movtos[prod -1]")
                                console.log(isNaN(movtos[prod-1]))
                                console.log("prod-1")
                                console.log(prod-1)

                                // // if (isNaN(movtos[prod]['data_movto'])) {
                                //     console.log("isNan")
                                ...
                                //     } else {
                                //         movtos[prod]['data_movto'] = this.subgrouped_items_bycolor_obj[ref_group][cor][prod].data_movto
                                //         movtos[prod][this.subgrouped_items_bycolor_obj[ref_group][cor][prod].des_tamanho.toString()] = 98
                        ...
                        // TODO is really necessary to sort the array by date the array or it is already sorted???
